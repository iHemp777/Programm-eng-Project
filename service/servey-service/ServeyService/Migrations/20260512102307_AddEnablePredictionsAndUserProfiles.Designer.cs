...
namespace SurveyService.Migrations
{
    ...
    [Migration("20260512102307_AddEnablePredictionsAndUserProfiles")]
    partial class AddEnablePredictionsAndUserProfiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyService.Models.SurveyPrediction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SurveyPredictions");
                });

            modelBuilder.Entity("SurveyService.Models.SurveyPredictionAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PredictionId", "QuestionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SurveyService.Models.SurveyPredictionAnswer", b =>
                {
                    b.HasOne("SurveyService.Models.SurveyPrediction", "Prediction")
                        .WithMany("Answers")
